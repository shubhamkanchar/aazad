                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cases mb-40">
                        <div class="cases-img" style="width: 100%;height: 250px;">
                            <img src="{{ url('public/uploads/donation').'/'.$d->file }}" alt="">
                        </div>
                        <div class="cases-caption" >
                            <h3><a href="#">{{ GoogleTranslate::trans($d->name, session()->get('lang_code'), 'en'); }}</a></h3>
                            <!-- Progress Bar -->
                            @php
                            $percentage=(20000/$d->goal)*100;
                            @endphp
